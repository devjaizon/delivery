export function createNotificationModal(themeColors) {
    ...
    notification.className = 'fixed bottom-20 right-4 px-6 py-3 rounded-lg shadow-lg transform translate-x-full transition-transform duration-500 ease-out z-50';
